...
export function SparePartSelector({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {/* Category Selector */}
      <div>
        <label htmlFor="spare-part-category" className="block text-sm font-medium text-gray-700 mb-1">
      ...
      {/* Part Name Selector */}
      <div>
        <label htmlFor="spare-part-name" className="block text-sm font-medium text-gray-700 mb-1">
