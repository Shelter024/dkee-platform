...
export default function AutomotivePage() {
  ...
  const services = [
    ...
    },
    {
      ...
      fullDescription: 'Using state-of-the-art diagnostic equipment, we identify issues before they become major problems. Our technicians are trained to interpret diagnostic codes specific to vehicles commonly used in Ghana.',
      benefits: [
        'Early problem detection saves money',
        'Accurate diagnosis eliminates guesswork',
    ...
    },
    {
      ...
      fullDescription: 'Access to verified genuine spare parts through our vetted supply chain. We stock parts for popular vehicle makes in Ghana and can source specialized components with fast turnaround times.',
      benefits: [
        'Guaranteed authentic OEM parts',
        'Protection against counterfeit components',
        'Compatibility assurance for your vehicle',
    ...
    },
    {
      ...
      fullDescription: 'Professional installation of GPS vehicle tracking systems with real-time monitoring capabilities. Protect your investment with 24/7 location tracking, geofencing alerts, and theft recovery support.',
      benefits: [
    ...
    },
    {
      ...
      fullDescription: 'Comprehensive fleet management services designed for Ghanaian businesses. From maintenance scheduling to driver management, we help you maximize uptime and minimize operating costs.',
      benefits: [
    ...
    },
    {
      ...
      fullDescription: 'Expert key programming and duplication services for modern vehicles with immobilizer systems. Lost your key? We can program replacement keys and transponders for most vehicle makes.',
      benefits: [
        'Emergency key replacement',
        'Spare key programming',
        'Immobilizer reset services',
    ...
    },
    {
      ...
      fullDescription: 'Professional body repair and painting services that restore your vehicle to showroom condition. Our paint booth ensures a perfect finish that withstands Ghana\'s tropical climate.',
      benefits: [
        'Professional paint matching',
        'Rust prevention treatment',
        'Insurance claim assistance',
        'Climate-resistant finishes',
        'Vehicle value restoration'
      ],
      features: [
        'Dent removal',
        'Panel beating',
    ...
    },
    {
      ...
      fullDescription: 'Emergency towing and roadside assistance available 24/7 across Ghana. Whether you\'re in Accra or on a highway, our recovery team is ready to help you get back on the road.',
      benefits: [
    ...
    },
    {
      ...
      fullDescription: 'Professional training programs and consultancy services for automotive businesses and fleet managers. Learn best practices for vehicle maintenance, cost optimization, and team development.',
      benefits: [
        'Industry expertise',
